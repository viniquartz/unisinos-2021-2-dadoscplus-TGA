            ...
            for (it = dados.begin(); it != dados.end(); ++it){
                ...
                if((*it)->get_scoreCVSS() >= begin_scoreCVSS  && (*it)->get_scoreCVSS() <= end_scoreCVSS){
                    ...
                    if(*end_publishdate > *begin_publishdate){
                        //if((*it)->publishDate->getStructMONTH >= *begin_publishdate->getStructMONTH && (*it)->publishDate->getStructDAY >= *begin_publishdate->getStructDAY && (*it)->publishDate->getStructMONTH <= *end_publishdate->getStructMONTH && (*it)->publishDate->getStructDAY <= *end_publishdate->getStructDAY){
